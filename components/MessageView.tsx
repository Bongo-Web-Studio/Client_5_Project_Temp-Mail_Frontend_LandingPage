    ...
    <>
      ...
      <div className="bg-white/10 backdrop-blur-md rounded-xl border border-white/20 overflow-hidden">
        <div className="p-6 border-b border-white/10 bg-white/5">
          <div className="flex items-start gap-4 mb-4">
            <div className="w-12 h-12 bg-gradient-to-br from-[#00FAFF] to-[#21FF7D] rounded-xl flex items-center justify-center text-[#002530] font-semibold">
              {(
                message.parsedData?.from?.charAt(0) ||
            ...
            <div className="flex-1">
              ...
              <div className="flex flex-wrap items-center gap-4 text-sm text-[#e8feff]/70">
                ...
                <div className="flex items-center gap-2">
                  ...
                  <span>
                    {new Date(
                      message.parsedData?.date || message.createdAt
        ...
        <div className="p-6">
          ...
          {message.parsedData?.attachments &&
            message.parsedData.attachments.length > 0 && (
              <div className="mt-6 pt-6 border-t border-white/10">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                  {message.parsedData.attachments.map(
                      ...
                      >
                        <div className="flex items-center gap-3">
                          ...
                          <div className="flex-1 min-w-0">
                            <p className="text-sm font-medium text-[#e8feff] truncate">
                              {attachment.filename || "Unnamed"}
                            </p>
                            <p className="text-xs text-[#e8feff]/60">
